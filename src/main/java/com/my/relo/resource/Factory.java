	...
	static {
		try {
			...
			if (sqlSessionFactory == null) {
				...
				//구현할 맵퍼 등록
				Class[] mapper = {com.my.relo.style.StyleDao.class, com.my.relo.likes.LikesDao.class,
						com.my.relo.reply.ReplyDao.class,com.my.relo.styletag.StyleTagDao.class};
				for (Class m : mapper) {
